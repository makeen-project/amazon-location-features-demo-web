...
const appConfig = {
	ENV: {
		...
		PINPOINT_REGION: getEnv("VITE_PINPOINT_REGION"),
		PINPOINT_APPLICATION_ID: getEnv("VITE_PINPOINT_APPLICATION_ID"),
		PINPOINT_ACCESS_KEY_ID: getEnv("VITE_PINPOINT_ACCESS_KEY_ID"),
		PINPOINT_SECRET_ACCESS_KEY: getEnv("VITE_PINPOINT_SECRET_ACCESS_KEY")
	},
